...
Question: do we want the trace to end with some concrete indication which property was violated? For example an assert with multiple conjuncts, or a procedure with multiple postconditions?
